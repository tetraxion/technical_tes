...
class _ChatWidgetState extends State<ChatWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      ...
      title: Text(widget.chat.user.name, style: theme.textTheme.titleMedium?.copyWith(fontSize: 16, fontWeight: FontWeight.bold),),
      visualDensity: VisualDensity.adaptivePlatformDensity,
      subtitle: Padding(
        padding: EdgeInsets.only(top: 8.0),
        child: Text(widget.chat.messages.last.text!, style: theme.textTheme.bodySmall?.copyWith(color: Colors.blueGrey.shade400),),
      ),
      trailing: widget.chat.unReadCount > 0 ? Column(
        ...
        children: [
          ...
          SizedBox(height: 8,),
          Text(widget.chat.lastMessageAt, style: theme.textTheme.bodySmall?.copyWith(color: Colors.blueGrey.shade300),),
        ],
      ) : Text(widget.chat.lastMessageAt, style: theme.textTheme.bodySmall?.copyWith(color: Colors.blueGrey.shade300),),
    ); 
  }
